    ...
    <div className="products-page-wrap">
      ...
      <section style={{ background:'var(--bg)', padding:'5rem 0' }}>
        <div className="section-wrap" ref={ref}>
          ...
          <div className="products-grid" style={{ display:'grid', gridTemplateColumns:'repeat(2,1fr)', gap:'3rem 1.5rem', paddingTop:'5rem' }}>
            {filtered.map((p, i) => (
      ...
      <section style={{ background:'var(--bg)', padding:'5rem 0' }} ref={ref}>
        <div className="section-wrap">
          ...
          <div style={{ marginTop:'4rem' }}>
            ...
            <div className="products-grid" style={{ display:'grid', gridTemplateColumns:'repeat(2,1fr)', gap:'3rem 1.5rem', alignItems:'stretch', paddingTop:'5rem' }}>
              {allRelated.map(p => (
